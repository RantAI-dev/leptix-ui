...
pub fn CheckboxPage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            css_usage="use leptix_ui::checkbox::*;\n\nview! {\n    <Checkbox attr:class=\"CheckboxRoot\" default_checked=CheckedState::True>\n        <CheckboxIndicator attr:class=\"CheckboxIndicator\">\n            \"\\u{2713}\"\n        </CheckboxIndicator>\n    </Checkbox>\n}"
            css_styles=".CheckboxRoot {\n  all: unset;\n  background-color: white;\n  width: 25px;\n  height: 25px;\n  border-radius: 4px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  box-shadow: 0 2px 10px var(--black-a7);\n}\n.CheckboxRoot:hover {\n  background-color: var(--violet-3);\n}\n.CheckboxRoot[data-state=\"checked\"] {\n  background-color: var(--violet-9);\n  color: white;\n}\n\n.CheckboxIndicator {\n  color: var(--violet-11);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.CheckboxRoot[data-state=\"checked\"] .CheckboxIndicator {\n  color: white;\n}"
            modules_usage="// import styles from \"./checkbox.module.css\";\nuse leptix_ui::checkbox::*;\n\nview! {\n    <Checkbox attr:class=styles.root default_checked=CheckedState::True>\n        <CheckboxIndicator attr:class=styles.indicator>\n            \"\\u{2713}\"\n        </CheckboxIndicator>\n    </Checkbox>\n}"
            modules_styles=".root {\n  all: unset;\n  background-color: white;\n  width: 25px;\n  height: 25px;\n  border-radius: 4px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  box-shadow: 0 2px 10px var(--black-a7);\n}\n.root:hover {\n  background-color: var(--violet-3);\n}\n.root[data-state=\"checked\"] {\n  background-color: var(--violet-9);\n  color: white;\n}\n\n.indicator {\n  color: var(--violet-11);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.root[data-state=\"checked\"] .indicator {\n  color: white;\n}"
            tailwind_usage="use leptix_ui::checkbox::*;\n\nview! {\n    <Checkbox attr:class=\"bg-white w-[25px] h-[25px] rounded flex items-center justify-center shadow-md hover:bg-violet-100 data-[state=checked]:bg-violet-500 data-[state=checked]:text-white\" default_checked=CheckedState::True>\n        <CheckboxIndicator attr:class=\"flex items-center justify-center text-violet-700 data-[state=checked]:text-white\">\n            \"\\u{2713}\"\n        </CheckboxIndicator>\n    </Checkbox>\n}"
            tailwind_config="import type { Config } from \"tailwindcss\";\n\nexport default {\n  theme: {\n    extend: {\n      colors: {\n        checkbox: {\n          bg: \"#ffffff\",\n          hover: \"var(--violet-3)\",\n          checked: \"var(--violet-9)\",\n          indicator: \"var(--violet-11)\",\n        },\n      },\n      boxShadow: {\n        checkbox: \"0 2px 10px var(--black-a7)\",\n      },\n    },\n  },\n} satisfies Config;"
        />

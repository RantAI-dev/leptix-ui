...
pub fn TogglePage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            css_usage="use leptix_ui::toggle::*;\n\nview! {\n    <Toggle attr:class=\"ToggleRoot\" default_pressed=false>\n        <span style=\"font-weight:700\">\"B\"</span>\n    </Toggle>\n}"
            css_styles=".ToggleRoot {\n  all: unset;\n  background-color: white;\n  color: var(--mauve-11);\n  height: 35px;\n  width: 35px;\n  border-radius: 4px;\n  display: flex;\n  font-size: 15px;\n  line-height: 1;\n  align-items: center;\n  justify-content: center;\n  box-shadow: 0 2px 10px var(--black-a7);\n  cursor: pointer;\n}\n.ToggleRoot:hover {\n  background-color: var(--violet-3);\n}\n.ToggleRoot[data-state=\"on\"] {\n  background-color: var(--violet-6);\n  color: var(--violet-12);\n}"
            modules_usage="// import styles from \"./toggle.module.css\";\nuse leptix_ui::toggle::*;\n\nview! {\n    <Toggle attr:class=styles.root default_pressed=false>\n        <span style=\"font-weight:700\">\"B\"</span>\n    </Toggle>\n}"
            modules_styles=".root {\n  all: unset;\n  background-color: white;\n  color: var(--mauve-11);\n  height: 35px;\n  width: 35px;\n  border-radius: 4px;\n  display: flex;\n  font-size: 15px;\n  line-height: 1;\n  align-items: center;\n  justify-content: center;\n  box-shadow: 0 2px 10px var(--black-a7);\n  cursor: pointer;\n}\n.root:hover {\n  background-color: var(--violet-3);\n}\n.root[data-state=\"on\"] {\n  background-color: var(--violet-6);\n  color: var(--violet-12);\n}"
            tailwind_usage="use leptix_ui::toggle::*;\n\nview! {\n    <Toggle attr:class=\"bg-white text-gray-700 h-[35px] w-[35px] rounded flex items-center justify-center shadow-md cursor-pointer hover:bg-violet-100 data-[state=on]:bg-violet-200 data-[state=on]:text-violet-900\" default_pressed=false>\n        <span class=\"font-bold\">\"B\"</span>\n    </Toggle>\n}"
            tailwind_config="import type { Config } from \"tailwindcss\";\n\nexport default {\n  theme: {\n    extend: {\n      colors: {\n        toggle: {\n          bg: \"#ffffff\",\n          text: \"var(--mauve-11)\",\n          hover: \"var(--violet-3)\",\n          active: \"var(--violet-6)\",\n          \"active-text\": \"var(--violet-12)\",\n        },\n      },\n      boxShadow: {\n        toggle: \"0 2px 10px var(--black-a7)\",\n      },\n    },\n  },\n} satisfies Config;"
        />

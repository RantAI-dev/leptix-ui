...
pub fn PopoverPage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            css_usage="use leptix_popover::*;\n\nview! {\n    <Popover>\n        <PopoverTrigger>\"Open Popover\"</PopoverTrigger>\n        <PopoverPortal>\n            <PopoverContent attr:class=\"PopoverContent\">\n                <p>\"Popover content here.\"</p>\n                <PopoverArrow />\n            </PopoverContent>\n        </PopoverPortal>\n    </Popover>\n}"
            css_styles=".PopoverContent {\n  border-radius: 4px;\n  padding: 20px;\n  width: 260px;\n  font-size: 14px;\n  line-height: 1.5;\n  background-color: white;\n  box-shadow: hsl(206 22% 7% / 35%) 0px 10px 38px -10px,\n    hsl(206 22% 7% / 20%) 0px 10px 20px -15px;\n  animation: scaleIn 200ms ease;\n}\n.PopoverContent:focus {\n  outline: none;\n  box-shadow: hsl(206 22% 7% / 35%) 0px 10px 38px -10px,\n    hsl(206 22% 7% / 20%) 0px 10px 20px -15px,\n    0 0 0 2px var(--violet-7);\n}\n\n@keyframes scaleIn {\n  from { opacity: 0; transform: scale(0.96); }\n  to { opacity: 1; transform: scale(1); }\n}"
            modules_usage="// import styles from \"./popover.module.css\";\nuse leptix_popover::*;\n\nview! {\n    <Popover>\n        <PopoverTrigger>\"Open Popover\"</PopoverTrigger>\n        <PopoverPortal>\n            <PopoverContent attr:class=styles.content>\n                <p>\"Popover content here.\"</p>\n                <PopoverArrow />\n            </PopoverContent>\n        </PopoverPortal>\n    </Popover>\n}"
            modules_styles=".content {\n  border-radius: 4px;\n  padding: 20px;\n  width: 260px;\n  font-size: 14px;\n  line-height: 1.5;\n  background-color: white;\n  box-shadow: hsl(206 22% 7% / 35%) 0px 10px 38px -10px,\n    hsl(206 22% 7% / 20%) 0px 10px 20px -15px;\n  animation: scaleIn 200ms ease;\n}\n.content:focus {\n  outline: none;\n  box-shadow: hsl(206 22% 7% / 35%) 0px 10px 38px -10px,\n    hsl(206 22% 7% / 20%) 0px 10px 20px -15px,\n    0 0 0 2px var(--violet-7);\n}\n\n@keyframes scaleIn {\n  from { opacity: 0; transform: scale(0.96); }\n  to { opacity: 1; transform: scale(1); }\n}"
            tailwind_usage="use leptix_popover::*;\n\nview! {\n    <Popover>\n        <PopoverTrigger>\"Open Popover\"</PopoverTrigger>\n        <PopoverPortal>\n            <PopoverContent attr:class=\"rounded p-5 w-[260px] text-sm leading-normal bg-white shadow-lg animate-scaleIn focus:outline-none focus:ring-2 focus:ring-violet-400\">\n                <p>\"Popover content here.\"</p>\n                <PopoverArrow />\n            </PopoverContent>\n        </PopoverPortal>\n    </Popover>\n}"

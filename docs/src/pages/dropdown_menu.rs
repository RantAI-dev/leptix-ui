...
pub fn DropdownMenuPage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            css_usage="use leptix_dropdown_menu::*;\n\nview! {\n    <DropdownMenu>\n        <DropdownMenuTrigger>\"Options\"</DropdownMenuTrigger>\n        <DropdownMenuPortal>\n            <DropdownMenuContent attr:class=\"DropdownMenuContent\">\n                <DropdownMenuItem attr:class=\"DropdownMenuItem\">\"New Tab\"</DropdownMenuItem>\n                <DropdownMenuItem attr:class=\"DropdownMenuItem\">\"New Window\"</DropdownMenuItem>\n                <DropdownMenuItem attr:class=\"DropdownMenuItem\" disabled=true>\"Print\"</DropdownMenuItem>\n                <DropdownMenuArrow />\n            </DropdownMenuContent>\n        </DropdownMenuPortal>\n    </DropdownMenu>\n}"
            css_styles=".DropdownMenuContent {\n  min-width: 220px;\n  background-color: white;\n  border-radius: 6px;\n  padding: 5px;\n  box-shadow: 0px 10px 38px -10px rgba(22, 23, 24, 0.35),\n    0px 10px 20px -15px rgba(22, 23, 24, 0.2);\n  animation: scaleIn 200ms ease;\n}\n\n.DropdownMenuItem {\n  font-size: 13px;\n  line-height: 1;\n  color: var(--violet-11);\n  border-radius: 3px;\n  display: flex;\n  align-items: center;\n  height: 25px;\n  padding: 0 5px 0 25px;\n  position: relative;\n  user-select: none;\n  outline: none;\n}\n.DropdownMenuItem[data-highlighted] {\n  background-color: var(--violet-9);\n  color: var(--violet-1);\n}\n.DropdownMenuItem[data-disabled] {\n  color: var(--mauve-8);\n  pointer-events: none;\n}\n\n@keyframes scaleIn {\n  from { opacity: 0; transform: scale(0.96); }\n  to { opacity: 1; transform: scale(1); }\n}"
            modules_usage="// import styles from \"./dropdown-menu.module.css\";\nuse leptix_dropdown_menu::*;\n\nview! {\n    <DropdownMenu>\n        <DropdownMenuTrigger>\"Options\"</DropdownMenuTrigger>\n        <DropdownMenuPortal>\n            <DropdownMenuContent attr:class=styles.content>\n                <DropdownMenuItem attr:class=styles.item>\"New Tab\"</DropdownMenuItem>\n                <DropdownMenuItem attr:class=styles.item>\"New Window\"</DropdownMenuItem>\n                <DropdownMenuItem attr:class=styles.item disabled=true>\"Print\"</DropdownMenuItem>\n                <DropdownMenuArrow />\n            </DropdownMenuContent>\n        </DropdownMenuPortal>\n    </DropdownMenu>\n}"
            modules_styles=".content {\n  min-width: 220px;\n  background-color: white;\n  border-radius: 6px;\n  padding: 5px;\n  box-shadow: 0px 10px 38px -10px rgba(22, 23, 24, 0.35),\n    0px 10px 20px -15px rgba(22, 23, 24, 0.2);\n  animation: scaleIn 200ms ease;\n}\n\n.item {\n  font-size: 13px;\n  line-height: 1;\n  color: var(--violet-11);\n  border-radius: 3px;\n  display: flex;\n  align-items: center;\n  height: 25px;\n  padding: 0 5px 0 25px;\n  position: relative;\n  user-select: none;\n  outline: none;\n}\n.item[data-highlighted] {\n  background-color: var(--violet-9);\n  color: var(--violet-1);\n}\n.item[data-disabled] {\n  color: var(--mauve-8);\n  pointer-events: none;\n}\n\n@keyframes scaleIn {\n  from { opacity: 0; transform: scale(0.96); }\n  to { opacity: 1; transform: scale(1); }\n}"
            tailwind_usage="use leptix_dropdown_menu::*;\n\nview! {\n    <DropdownMenu>\n        <DropdownMenuTrigger>\"Options\"</DropdownMenuTrigger>\n        <DropdownMenuPortal>\n            <DropdownMenuContent attr:class=\"min-w-[220px] bg-white rounded-md p-1 shadow-lg animate-scaleIn\">\n                <DropdownMenuItem attr:class=\"text-[13px] leading-none text-violet-700 rounded flex items-center h-[25px] pl-6 pr-1 relative select-none outline-none data-[highlighted]:bg-violet-500 data-[highlighted]:text-violet-50 data-[disabled]:text-gray-400 data-[disabled]:pointer-events-none\">\n                    \"New Tab\"\n                </DropdownMenuItem>\n            </DropdownMenuContent>\n        </DropdownMenuPortal>\n    </DropdownMenu>\n}"
            tailwind_config="import type { Config } from \"tailwindcss\";\n\nexport default {\n  theme: {\n    extend: {\n      keyframes: {\n        scaleIn: {\n          from: { opacity: \"0\", transform: \"scale(0.96)\" },\n          to: { opacity: \"1\", transform: \"scale(1)\" },\n        },\n      },\n      animation: {\n        scaleIn: \"scaleIn 200ms ease\",\n      },\n      colors: {\n        menu: {\n          text: \"var(--violet-11)\",\n          highlight: \"var(--violet-9)\",\n          \"highlight-text\": \"var(--violet-1)\",\n          disabled: \"var(--mauve-8)\",\n        },\n      },\n    },\n  },\n} satisfies Config;"
        />

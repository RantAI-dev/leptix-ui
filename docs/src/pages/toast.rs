...
pub fn ToastPage() -> impl IntoView {
    ...
    view! {
        ...
        <HeroCodeBlock
            usage_code="use leptix_ui::toast::*;\n\nlet (open, set_open) = signal(false);\n\nview! {\n    <ToastProvider>\n        <button on:click=move |_| set_open.set(true)>\n            \"Show Toast\"\n        </button>\n        <Toast open=open on_open_change=Callback::new(move |val: bool| set_open.set(val))>\n            <ToastTitle>\"Event Created\"</ToastTitle>\n            <ToastDescription>\"Your meeting has been scheduled.\"</ToastDescription>\n            <ToastClose>\"Dismiss\"</ToastClose>\n        </Toast>\n        <ToastViewport />\n    </ToastProvider>\n}"
            css_code=".ToastViewport {\n  position: fixed;\n  bottom: 0;\n  right: 0;\n  display: flex;\n  flex-direction: column;\n  padding: 25px;\n  gap: 10px;\n  width: 390px;\n  max-width: 100vw;\n  z-index: 2147483647;\n  outline: none;\n}\n\n.ToastRoot {\n  background-color: white;\n  border-radius: 6px;\n  box-shadow: 0 10px 38px -10px rgba(22,23,24,.35),\n    0 10px 20px -15px rgba(22,23,24,.2);\n  padding: 15px;\n  display: grid;\n  grid-template-areas: \"title action\" \"description action\";\n  grid-template-columns: auto max-content;\n  column-gap: 15px;\n  align-items: center;\n}\n\n.ToastTitle {\n  grid-area: title;\n  margin-bottom: 5px;\n  font-weight: 500;\n  color: var(--slate-12);\n  font-size: 15px;\n}\n\n.ToastDescription {\n  grid-area: description;\n  margin: 0;\n  color: var(--slate-11);\n  font-size: 13px;\n  line-height: 1.3;\n}\n\n.ToastClose {\n  grid-area: action;\n  font-size: 12px;\n}"
            css_modules_code=".Viewport {\n  position: fixed;\n  bottom: 0;\n  right: 0;\n  display: flex;\n  flex-direction: column;\n  padding: 25px;\n  gap: 10px;\n  width: 390px;\n  max-width: 100vw;\n  z-index: 2147483647;\n  outline: none;\n}\n\n.Root {\n  background-color: white;\n  border-radius: 6px;\n  box-shadow: 0 10px 38px -10px rgba(22,23,24,.35),\n    0 10px 20px -15px rgba(22,23,24,.2);\n  padding: 15px;\n  display: grid;\n  grid-template-areas: \"title action\" \"description action\";\n  grid-template-columns: auto max-content;\n  column-gap: 15px;\n  align-items: center;\n}\n\n.Title {\n  grid-area: title;\n  margin-bottom: 5px;\n  font-weight: 500;\n  color: var(--slate-12);\n  font-size: 15px;\n}\n\n.Description {\n  grid-area: description;\n  margin: 0;\n  color: var(--slate-11);\n  font-size: 13px;\n  line-height: 1.3;\n}\n\n.Close {\n  grid-area: action;\n  font-size: 12px;\n}"
            tailwind_code="view! {\n    <ToastProvider>\n        <button on:click=move |_| set_open.set(true)\n            class=\"px-5 py-2 rounded-md bg-violet-500 text-white font-medium\">\n            \"Show Toast\"\n        </button>\n        <Toast open=open on_open_change=Callback::new(move |val: bool| set_open.set(val))\n            class=\"bg-white rounded-md shadow-lg p-4 grid grid-cols-[auto_max-content] gap-x-4 items-center\">\n            <ToastTitle class=\"mb-1 font-medium text-slate-900 text-sm\">\n                \"Event Created\"\n            </ToastTitle>\n            <ToastDescription class=\"text-slate-500 text-xs leading-tight\">\n                \"Your meeting has been scheduled.\"\n            </ToastDescription>\n            <ToastClose class=\"text-xs\">\"Dismiss\"</ToastClose>\n        </Toast>\n        <ToastViewport class=\"fixed bottom-0 right-0 flex flex-col p-6 gap-2.5 w-[390px] max-w-screen z-[2147483647] outline-none\" />\n    </ToastProvider>\n}"
        />

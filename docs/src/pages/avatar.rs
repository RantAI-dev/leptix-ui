...
pub fn AvatarPage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            css_usage="use leptix_ui::avatar::*;\n\nview! {\n    <Avatar attr:class=\"AvatarRoot\">\n        <AvatarImage attr:class=\"AvatarImage\" src=\"https://i.pravatar.cc/48?u=leptix\" />\n        <AvatarFallback attr:class=\"AvatarFallback\">\"JD\"</AvatarFallback>\n    </Avatar>\n}"
            css_styles=".AvatarRoot {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  vertical-align: middle;\n  overflow: hidden;\n  user-select: none;\n  width: 45px;\n  height: 45px;\n  border-radius: 100%;\n  background-color: var(--black-a3);\n}\n\n.AvatarImage {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  border-radius: inherit;\n}\n\n.AvatarFallback {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: white;\n  color: var(--violet-11);\n  font-size: 15px;\n  line-height: 1;\n  font-weight: 500;\n}"
            modules_usage="// import styles from \"./avatar.module.css\";\nuse leptix_ui::avatar::*;\n\nview! {\n    <Avatar attr:class=styles.root>\n        <AvatarImage attr:class=styles.image src=\"https://i.pravatar.cc/48?u=leptix\" />\n        <AvatarFallback attr:class=styles.fallback>\"JD\"</AvatarFallback>\n    </Avatar>\n}"
            modules_styles=".root {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  vertical-align: middle;\n  overflow: hidden;\n  user-select: none;\n  width: 45px;\n  height: 45px;\n  border-radius: 100%;\n  background-color: var(--black-a3);\n}\n\n.image {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  border-radius: inherit;\n}\n\n.fallback {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: white;\n  color: var(--violet-11);\n  font-size: 15px;\n  line-height: 1;\n  font-weight: 500;\n}"
            tailwind_usage="use leptix_ui::avatar::*;\n\nview! {\n    <Avatar attr:class=\"inline-flex items-center justify-center align-middle overflow-hidden select-none w-[45px] h-[45px] rounded-full bg-black/10\">\n        <AvatarImage attr:class=\"w-full h-full object-cover rounded-[inherit]\" src=\"https://i.pravatar.cc/48?u=leptix\" />\n        <AvatarFallback attr:class=\"w-full h-full flex items-center justify-center bg-white text-violet-700 text-sm font-medium\">\n            \"JD\"\n        </AvatarFallback>\n    </Avatar>\n}"
            tailwind_config="import type { Config } from \"tailwindcss\";\n\nexport default {\n  theme: {\n    extend: {\n      colors: {\n        avatar: {\n          bg: \"var(--black-a3)\",\n          fallback: \"#ffffff\",\n          \"fallback-text\": \"var(--violet-11)\",\n        },\n      },\n      width: {\n        avatar: \"45px\",\n      },\n      height: {\n        avatar: \"45px\",\n      },\n    },\n  },\n} satisfies Config;"
        />

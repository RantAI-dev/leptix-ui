...
pub fn TabsPage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            css_usage="use leptix_ui::tabs::*;\n\nview! {\n    <Tabs default_value=\"account\">\n        <TabsList attr:class=\"TabsList\">\n            <TabsTrigger value=\"account\" attr:class=\"TabsTrigger\">\"Account\"</TabsTrigger>\n            <TabsTrigger value=\"password\" attr:class=\"TabsTrigger\">\"Password\"</TabsTrigger>\n        </TabsList>\n        <TabsContent value=\"account\" attr:class=\"TabsContent\">\"Account content\"</TabsContent>\n        <TabsContent value=\"password\" attr:class=\"TabsContent\">\"Password content\"</TabsContent>\n    </Tabs>\n}"
            css_styles=".TabsList {\n  display: flex;\n  border-bottom: 1px solid var(--mauve-6);\n  flex-shrink: 0;\n}\n\n.TabsTrigger {\n  all: unset;\n  font-family: inherit;\n  padding: 0 20px;\n  height: 45px;\n  flex: 1;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 15px;\n  line-height: 1;\n  color: var(--mauve-11);\n  user-select: none;\n  cursor: pointer;\n}\n.TabsTrigger[data-state=\"active\"] {\n  color: var(--violet-11);\n  box-shadow: inset 0 -1px 0 0 currentColor, 0 1px 0 0 currentColor;\n}\n\n.TabsContent {\n  flex-grow: 1;\n  padding: 20px;\n  outline: none;\n}"
            modules_usage="// import styles from \"./tabs.module.css\";\nuse leptix_ui::tabs::*;\n\nview! {\n    <Tabs default_value=\"account\">\n        <TabsList attr:class=styles.list>\n            <TabsTrigger value=\"account\" attr:class=styles.trigger>\"Account\"</TabsTrigger>\n            <TabsTrigger value=\"password\" attr:class=styles.trigger>\"Password\"</TabsTrigger>\n        </TabsList>\n        <TabsContent value=\"account\" attr:class=styles.content>\"Account content\"</TabsContent>\n        <TabsContent value=\"password\" attr:class=styles.content>\"Password content\"</TabsContent>\n    </Tabs>\n}"
            modules_styles=".list {\n  display: flex;\n  border-bottom: 1px solid var(--mauve-6);\n  flex-shrink: 0;\n}\n\n.trigger {\n  all: unset;\n  font-family: inherit;\n  padding: 0 20px;\n  height: 45px;\n  flex: 1;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 15px;\n  line-height: 1;\n  color: var(--mauve-11);\n  user-select: none;\n  cursor: pointer;\n}\n.trigger[data-state=\"active\"] {\n  color: var(--violet-11);\n  box-shadow: inset 0 -1px 0 0 currentColor, 0 1px 0 0 currentColor;\n}\n\n.content {\n  flex-grow: 1;\n  padding: 20px;\n  outline: none;\n}"
            tailwind_usage="use leptix_ui::tabs::*;\n\nview! {\n    <Tabs default_value=\"account\">\n        <TabsList attr:class=\"flex border-b border-gray-200 shrink-0\">\n            <TabsTrigger value=\"account\" attr:class=\"flex-1 flex items-center justify-center px-5 h-[45px] text-sm text-gray-500 cursor-pointer select-none data-[state=active]:text-violet-700 data-[state=active]:shadow-[inset_0_-1px_0_0_currentColor,0_1px_0_0_currentColor]\">\"Account\"</TabsTrigger>\n            <TabsTrigger value=\"password\" attr:class=\"flex-1 flex items-center justify-center px-5 h-[45px] text-sm text-gray-500 cursor-pointer select-none data-[state=active]:text-violet-700 data-[state=active]:shadow-[inset_0_-1px_0_0_currentColor,0_1px_0_0_currentColor]\">\"Password\"</TabsTrigger>\n        </TabsList>\n        <TabsContent value=\"account\" attr:class=\"grow p-5 outline-none\">\"Account content\"</TabsContent>\n        <TabsContent value=\"password\" attr:class=\"grow p-5 outline-none\">\"Password content\"</TabsContent>\n    </Tabs>\n}"

...
pub fn ProgressPage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            css_usage="use leptix_progress::*;\n\nview! {\n    <Progress attr:class=\"ProgressRoot\" value=66.0>\n        <ProgressIndicator attr:class=\"ProgressIndicator\" />\n    </Progress>\n}"
            css_styles=".ProgressRoot {\n  position: relative;\n  overflow: hidden;\n  background: var(--black-a9);\n  border-radius: 99999px;\n  width: 300px;\n  height: 25px;\n  transform: translateZ(0);\n}\n\n.ProgressIndicator {\n  background-color: white;\n  width: 100%;\n  height: 100%;\n  transition: transform 660ms cubic-bezier(0.65, 0, 0.35, 1);\n}\n.ProgressRoot[data-state=\"indeterminate\"] .ProgressIndicator {\n  background-color: var(--mauve-8);\n}"
            modules_usage="// import styles from \"./progress.module.css\";\nuse leptix_progress::*;\n\nview! {\n    <Progress attr:class=styles.root value=66.0>\n        <ProgressIndicator attr:class=styles.indicator />\n    </Progress>\n}"
            modules_styles=".root {\n  position: relative;\n  overflow: hidden;\n  background: var(--black-a9);\n  border-radius: 99999px;\n  width: 300px;\n  height: 25px;\n  transform: translateZ(0);\n}\n\n.indicator {\n  background-color: white;\n  width: 100%;\n  height: 100%;\n  transition: transform 660ms cubic-bezier(0.65, 0, 0.35, 1);\n}\n.root[data-state=\"indeterminate\"] .indicator {\n  background-color: var(--mauve-8);\n}"
            tailwind_usage="use leptix_progress::*;\n\nview! {\n    <Progress attr:class=\"relative overflow-hidden bg-black/40 rounded-full w-[300px] h-[25px]\" value=66.0>\n        <ProgressIndicator attr:class=\"bg-white w-full h-full transition-transform duration-[660ms] ease-[cubic-bezier(0.65,0,0.35,1)]\" />\n    </Progress>\n}"
            tailwind_config="import type { Config } from \"tailwindcss\";\n\nexport default {\n  theme: {\n    extend: {\n      colors: {\n        progress: {\n          track: \"var(--black-a9)\",\n          indicator: \"#ffffff\",\n          indeterminate: \"var(--mauve-8)\",\n        },\n      },\n      transitionDuration: {\n        progress: \"660ms\",\n      },\n      transitionTimingFunction: {\n        progress: \"cubic-bezier(0.65, 0, 0.35, 1)\",\n      },\n    },\n  },\n} satisfies Config;"
        />

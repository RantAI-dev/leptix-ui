...
pub fn NavigationMenuPage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            css_usage="use leptix_ui::navigation_menu::*;\n\nview! {\n    <NavigationMenu attr:class=\"NavigationMenuRoot\">\n        <NavigationMenuList attr:class=\"NavigationMenuList\">\n            <NavigationMenuItem>\n                <NavigationMenuLink attr:class=\"NavigationMenuLink\">\"Getting Started\"</NavigationMenuLink>\n            </NavigationMenuItem>\n            <NavigationMenuItem>\n                <NavigationMenuLink attr:class=\"NavigationMenuLink\">\"Components\"</NavigationMenuLink>\n            </NavigationMenuItem>\n            <NavigationMenuItem>\n                <NavigationMenuLink attr:class=\"NavigationMenuLink\">\"Documentation\"</NavigationMenuLink>\n            </NavigationMenuItem>\n        </NavigationMenuList>\n    </NavigationMenu>\n}"
            css_styles=".NavigationMenuRoot {\n  display: flex;\n  justify-content: center;\n  width: 100%;\n}\n\n.NavigationMenuList {\n  display: flex;\n  justify-content: center;\n  background-color: white;\n  padding: 4px;\n  border-radius: 6px;\n  list-style: none;\n  box-shadow: 0 2px 10px var(--black-a7);\n}\n\n.NavigationMenuLink {\n  display: block;\n  text-decoration: none;\n  font-size: 15px;\n  line-height: 1;\n  padding: 8px 12px;\n  border-radius: 4px;\n  color: var(--violet-11);\n  font-weight: 500;\n}\n\n.NavigationMenuLink:hover {\n  background-color: var(--violet-3);\n}"
            modules_usage="use leptix_ui::navigation_menu::*;\n// use styles from module\n\nview! {\n    <NavigationMenu attr:class=styles.root>\n        <NavigationMenuList attr:class=styles.list>\n            <NavigationMenuItem>\n                <NavigationMenuLink attr:class=styles.link>\"Getting Started\"</NavigationMenuLink>\n            </NavigationMenuItem>\n            <NavigationMenuItem>\n                <NavigationMenuLink attr:class=styles.link>\"Components\"</NavigationMenuLink>\n            </NavigationMenuItem>\n            <NavigationMenuItem>\n                <NavigationMenuLink attr:class=styles.link>\"Documentation\"</NavigationMenuLink>\n            </NavigationMenuItem>\n        </NavigationMenuList>\n    </NavigationMenu>\n}"
            modules_styles=".root {\n  display: flex;\n  justify-content: center;\n  width: 100%;\n}\n\n.list {\n  display: flex;\n  justify-content: center;\n  background-color: white;\n  padding: 4px;\n  border-radius: 6px;\n  list-style: none;\n  box-shadow: 0 2px 10px var(--black-a7);\n}\n\n.link {\n  display: block;\n  text-decoration: none;\n  font-size: 15px;\n  line-height: 1;\n  padding: 8px 12px;\n  border-radius: 4px;\n  color: var(--violet-11);\n  font-weight: 500;\n}\n\n.link:hover {\n  background-color: var(--violet-3);\n}"
            tailwind_usage="use leptix_ui::navigation_menu::*;\n\nview! {\n    <NavigationMenu attr:class=\"flex justify-center w-full\">\n        <NavigationMenuList attr:class=\"flex justify-center bg-white p-1 rounded-md list-none shadow-md\">\n            <NavigationMenuItem>\n                <NavigationMenuLink attr:class=\"block no-underline text-sm py-2 px-3 rounded text-violet-700 font-medium hover:bg-violet-100\">\n                    \"Getting Started\"\n                </NavigationMenuLink>\n            </NavigationMenuItem>\n            <NavigationMenuItem>\n                <NavigationMenuLink attr:class=\"block no-underline text-sm py-2 px-3 rounded text-violet-700 font-medium hover:bg-violet-100\">\n                    \"Components\"\n                </NavigationMenuLink>\n            </NavigationMenuItem>\n        </NavigationMenuList>\n    </NavigationMenu>\n}"

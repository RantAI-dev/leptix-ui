...
pub fn MenubarPage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            usage_code="use leptix_ui::menubar::*;\n\nview! {\n    <Menubar>\n        <MenubarMenu>\n            <MenubarTrigger>\"File\"</MenubarTrigger>\n            <MenubarPortal>\n                <MenubarContent>\n                    <MenubarItem>\"New Tab\"</MenubarItem>\n                    <MenubarItem>\"New Window\"</MenubarItem>\n                    <MenubarSeparator />\n                    <MenubarItem>\"Print\"</MenubarItem>\n                </MenubarContent>\n            </MenubarPortal>\n        </MenubarMenu>\n    </Menubar>\n}"
            css_code=".MenubarRoot {\n  display: flex;\n  background-color: white;\n  padding: 3px;\n  border-radius: 6px;\n  box-shadow: 0 2px 10px var(--black-a7);\n}\n\n.MenubarTrigger {\n  padding: 8px 12px;\n  outline: none;\n  user-select: none;\n  font-weight: 500;\n  line-height: 1;\n  border-radius: 4px;\n  color: var(--violet-11);\n  font-size: 13px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 2px;\n}\n\n.MenubarTrigger[data-highlighted],\n.MenubarTrigger[data-state=\"open\"] {\n  background-color: var(--violet-4);\n}\n\n.MenubarContent {\n  min-width: 180px;\n  background-color: white;\n  border-radius: 6px;\n  padding: 5px;\n  box-shadow: 0 10px 38px -10px rgba(22,23,24,.35),\n    0 10px 20px -15px rgba(22,23,24,.2);\n}\n\n.MenubarItem {\n  font-size: 13px;\n  line-height: 1;\n  color: var(--violet-11);\n  border-radius: 3px;\n  display: flex;\n  align-items: center;\n  height: 25px;\n  padding: 0 10px;\n  position: relative;\n  user-select: none;\n  outline: none;\n}\n\n.MenubarItem[data-highlighted] {\n  background-color: var(--violet-9);\n  color: var(--violet-1);\n}\n\n.MenubarSeparator {\n  height: 1px;\n  background-color: var(--violet-6);\n  margin: 5px;\n}"
            css_modules_code=".Root {\n  display: flex;\n  background-color: white;\n  padding: 3px;\n  border-radius: 6px;\n  box-shadow: 0 2px 10px var(--black-a7);\n}\n\n.Trigger {\n  padding: 8px 12px;\n  outline: none;\n  user-select: none;\n  font-weight: 500;\n  line-height: 1;\n  border-radius: 4px;\n  color: var(--violet-11);\n  font-size: 13px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 2px;\n}\n\n.Trigger[data-highlighted],\n.Trigger[data-state=\"open\"] {\n  background-color: var(--violet-4);\n}\n\n.Content {\n  min-width: 180px;\n  background-color: white;\n  border-radius: 6px;\n  padding: 5px;\n  box-shadow: 0 10px 38px -10px rgba(22,23,24,.35),\n    0 10px 20px -15px rgba(22,23,24,.2);\n}\n\n.Item {\n  font-size: 13px;\n  line-height: 1;\n  color: var(--violet-11);\n  border-radius: 3px;\n  display: flex;\n  align-items: center;\n  height: 25px;\n  padding: 0 10px;\n  position: relative;\n  user-select: none;\n  outline: none;\n}\n\n.Item[data-highlighted] {\n  background-color: var(--violet-9);\n  color: var(--violet-1);\n}\n\n.Separator {\n  height: 1px;\n  background-color: var(--violet-6);\n  margin: 5px;\n}"
            tailwind_code="view! {\n    <Menubar class=\"flex bg-white p-0.5 rounded-md shadow-md\">\n        <MenubarMenu>\n            <MenubarTrigger class=\"py-2 px-3 outline-none select-none font-medium rounded text-violet-700 text-sm flex items-center gap-0.5 data-[highlighted]:bg-violet-100 data-[state=open]:bg-violet-100\">\n                \"File\"\n            </MenubarTrigger>\n            <MenubarPortal>\n                <MenubarContent class=\"min-w-[180px] bg-white rounded-md p-1 shadow-lg\">\n                    <MenubarItem class=\"text-sm text-violet-700 rounded flex items-center h-[25px] px-2.5 select-none outline-none data-[highlighted]:bg-violet-500 data-[highlighted]:text-white\">\n                        \"New Tab\"\n                    </MenubarItem>\n                    <MenubarSeparator class=\"h-px bg-violet-200 m-1\" />\n                    <MenubarItem class=\"text-sm text-violet-700 rounded flex items-center h-[25px] px-2.5 select-none outline-none data-[highlighted]:bg-violet-500 data-[highlighted]:text-white\">\n                        \"Print\"\n                    </MenubarItem>\n                </MenubarContent>\n            </MenubarPortal>\n        </MenubarMenu>\n    </Menubar>\n}"
        />

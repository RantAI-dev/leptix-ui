...
pub fn ToggleGroupPage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            css_usage="use leptix_toggle_group::*;\n\nview! {\n    <ToggleGroup r#type=ToggleGroupType::Single attr:class=\"ToggleGroupRoot\">\n        <ToggleGroupItem attr:class=\"ToggleGroupItem\" value=\"bold\">\"B\"</ToggleGroupItem>\n        <ToggleGroupItem attr:class=\"ToggleGroupItem\" value=\"italic\">\"I\"</ToggleGroupItem>\n        <ToggleGroupItem attr:class=\"ToggleGroupItem\" value=\"underline\">\"U\"</ToggleGroupItem>\n    </ToggleGroup>\n}"
            css_styles=".ToggleGroupRoot {\n  display: inline-flex;\n  background-color: var(--mauve-6);\n  border-radius: 4px;\n  box-shadow: 0 2px 10px var(--black-a7);\n}\n\n.ToggleGroupItem {\n  all: unset;\n  background-color: white;\n  color: var(--mauve-11);\n  height: 35px;\n  width: 35px;\n  display: flex;\n  font-size: 15px;\n  line-height: 1;\n  align-items: center;\n  justify-content: center;\n  margin-left: 1px;\n  cursor: pointer;\n}\n.ToggleGroupItem:first-child {\n  margin-left: 0;\n  border-top-left-radius: 4px;\n  border-bottom-left-radius: 4px;\n}\n.ToggleGroupItem:last-child {\n  border-top-right-radius: 4px;\n  border-bottom-right-radius: 4px;\n}\n.ToggleGroupItem:hover {\n  background-color: var(--violet-3);\n}\n.ToggleGroupItem[data-state=\"on\"] {\n  background-color: var(--violet-6);\n  color: var(--violet-12);\n}"
            modules_usage="use leptix_toggle_group::*;\n// use styles from module\n\nview! {\n    <ToggleGroup r#type=ToggleGroupType::Single attr:class=styles.root>\n        <ToggleGroupItem attr:class=styles.item value=\"bold\">\"B\"</ToggleGroupItem>\n        <ToggleGroupItem attr:class=styles.item value=\"italic\">\"I\"</ToggleGroupItem>\n        <ToggleGroupItem attr:class=styles.item value=\"underline\">\"U\"</ToggleGroupItem>\n    </ToggleGroup>\n}"
            modules_styles=".root {\n  display: inline-flex;\n  background-color: var(--mauve-6);\n  border-radius: 4px;\n  box-shadow: 0 2px 10px var(--black-a7);\n}\n\n.item {\n  all: unset;\n  background-color: white;\n  color: var(--mauve-11);\n  height: 35px;\n  width: 35px;\n  display: flex;\n  font-size: 15px;\n  line-height: 1;\n  align-items: center;\n  justify-content: center;\n  margin-left: 1px;\n  cursor: pointer;\n}\n.item:first-child {\n  margin-left: 0;\n  border-top-left-radius: 4px;\n  border-bottom-left-radius: 4px;\n}\n.item:last-child {\n  border-top-right-radius: 4px;\n  border-bottom-right-radius: 4px;\n}\n.item:hover {\n  background-color: var(--violet-3);\n}\n.item[data-state=\"on\"] {\n  background-color: var(--violet-6);\n  color: var(--violet-12);\n}"
            tailwind_usage="use leptix_toggle_group::*;\n\nview! {\n    <ToggleGroup r#type=ToggleGroupType::Single attr:class=\"inline-flex bg-gray-200 rounded shadow-md\">\n        <ToggleGroupItem attr:class=\"bg-white text-gray-700 h-[35px] w-[35px] flex items-center justify-center text-[15px] leading-none ml-px cursor-pointer first:ml-0 first:rounded-l last:rounded-r hover:bg-violet-100 data-[state=on]:bg-violet-200 data-[state=on]:text-violet-900\" value=\"bold\">\n            \"B\"\n        </ToggleGroupItem>\n    </ToggleGroup>\n}"

...
pub fn SelectPage() -> impl IntoView {
    view! {
        ...
        <HeroCodeBlock
            usage_code="use leptix_ui::select::*;\n\nview! {\n    <Select>\n        <SelectTrigger>\n            <SelectValue placeholder=\"Select a fruit\" />\n        </SelectTrigger>\n        <SelectPortal>\n            <SelectContent>\n                <SelectViewport>\n                    <SelectItem value=\"apple\">\n                        <SelectItemText>\"Apple\"</SelectItemText>\n                    </SelectItem>\n                    <SelectItem value=\"banana\">\n                        <SelectItemText>\"Banana\"</SelectItemText>\n                    </SelectItem>\n                </SelectViewport>\n            </SelectContent>\n        </SelectPortal>\n    </Select>\n}"
            css_code=".SelectTrigger {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 4px;\n  padding: 0 15px;\n  font-size: 13px;\n  line-height: 1;\n  height: 35px;\n  gap: 5px;\n  background-color: white;\n  color: var(--violet-11);\n  box-shadow: 0 2px 10px var(--black-a7);\n}\n\n.SelectTrigger:hover {\n  background-color: var(--violet-3);\n}\n\n.SelectContent {\n  overflow: hidden;\n  background-color: white;\n  border-radius: 6px;\n  box-shadow: 0 10px 38px -10px rgba(22,23,24,.35),\n    0 10px 20px -15px rgba(22,23,24,.2);\n}\n\n.SelectViewport {\n  padding: 5px;\n}\n\n.SelectItem {\n  font-size: 13px;\n  line-height: 1;\n  color: var(--violet-11);\n  border-radius: 3px;\n  display: flex;\n  align-items: center;\n  height: 25px;\n  padding: 0 35px 0 25px;\n  position: relative;\n  user-select: none;\n  outline: none;\n}\n\n.SelectItem[data-highlighted] {\n  background-color: var(--violet-9);\n  color: var(--violet-1);\n}"
            css_modules_code=".Trigger {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 4px;\n  padding: 0 15px;\n  font-size: 13px;\n  line-height: 1;\n  height: 35px;\n  gap: 5px;\n  background-color: white;\n  color: var(--violet-11);\n  box-shadow: 0 2px 10px var(--black-a7);\n}\n\n.Trigger:hover {\n  background-color: var(--violet-3);\n}\n\n.Content {\n  overflow: hidden;\n  background-color: white;\n  border-radius: 6px;\n  box-shadow: 0 10px 38px -10px rgba(22,23,24,.35),\n    0 10px 20px -15px rgba(22,23,24,.2);\n}\n\n.Viewport {\n  padding: 5px;\n}\n\n.Item {\n  font-size: 13px;\n  line-height: 1;\n  color: var(--violet-11);\n  border-radius: 3px;\n  display: flex;\n  align-items: center;\n  height: 25px;\n  padding: 0 35px 0 25px;\n  position: relative;\n  user-select: none;\n  outline: none;\n}\n\n.Item[data-highlighted] {\n  background-color: var(--violet-9);\n  color: var(--violet-1);\n}"
            tailwind_code="view! {\n    <Select>\n        <SelectTrigger class=\"inline-flex items-center justify-center rounded px-4 text-sm h-[35px] gap-1 bg-white text-violet-700 shadow-md hover:bg-violet-100\">\n            <SelectValue placeholder=\"Select a fruit\" />\n        </SelectTrigger>\n        <SelectPortal>\n            <SelectContent class=\"overflow-hidden bg-white rounded-md shadow-lg\">\n                <SelectViewport class=\"p-1\">\n                    <SelectItem value=\"apple\"\n                        class=\"text-sm text-violet-700 rounded flex items-center h-[25px] pr-9 pl-6 select-none outline-none data-[highlighted]:bg-violet-500 data-[highlighted]:text-white\">\n                        <SelectItemText>\"Apple\"</SelectItemText>\n                    </SelectItem>\n                </SelectViewport>\n            </SelectContent>\n        </SelectPortal>\n    </Select>\n}"
        />
